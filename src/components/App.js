...
class App extends Component {
  ...
  searchAppointments = text => this.setState({queryText:text});
  ...
  render(){
    ...
    filteredApts = filteredApts.sort((a,b)=>{
      let retVal = (  a[this.state.orderBy].toLowerCase() < 
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 bg-white">
            <div className="container">
              <AddAppointments formDisplay={this.state.formDisplay} toggleDisplay={this.toggleDisplay} addAppointment={this.addAppointment} />
